...
urlpatterns = [
    ...
    path("password-reset/", auth_views.PasswordResetView.as_view(template_name="users/password_reset.html",email_template_name="users/email_pass_reset.html"), name="password_reset"),
